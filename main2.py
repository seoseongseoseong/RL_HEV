...
config = {"gamma": gamma, "tau": tau, "batch_size": batch_size, "learning_rate": learning_rate}
...
model = TD3("MlpPolicy", env, learning_rate=learning_rate, buffer_size=buffer_size, learning_starts=learning_starts, batch_size=batch_size,
...
model.learn(total_timesteps = episodes*total_timesteps, callback = callbacks, log_interval=4)
del model


best_model = TD3.load(os.path.join(save_dir, "best_model"))
